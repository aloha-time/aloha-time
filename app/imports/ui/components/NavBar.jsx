      ...
      <Menu.Item position="right">
        {currentUser === '' ? (
          ...
          <Dropdown id={COMPONENT_IDS.NAVBAR_USER_HAMBURGER_MENU} icon="bars" pointing="top right" key="userMainMenu">
            <Dropdown.Menu>
              <Dropdown.Item id={COMPONENT_IDS.NAVBAR_USER_HAMBURGER_MENU_BROWSE_OPPORTUNITIES} text="Browse Opportunities" as={NavLink} exact to="/browseOpportunities" />
              <Dropdown.Item id={COMPONENT_IDS.NAVBAR_USER_HAMBURGER_MENU_ORGANIZATION_LIBRARY} text="Organization Library" as={NavLink} exact to="/organizationLibrary" />
              <Dropdown.Item id={COMPONENT_IDS.NAVBAR_USER_HAMBURGER_MENU_ABOUT_US} text="About Us" as={NavLink} exact to="/aboutUs"/>
            </Dropdown.Menu>
          </Dropdown>]
        ) }
      </Menu.Item>
