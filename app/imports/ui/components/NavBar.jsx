    ...
    <Menu style={menuStyle} attached="top" borderless inverted>
      ...
      {currentUser ? (
        [<Menu.Item id={COMPONENT_IDS.NAVBAR_ADD_STUFF} as={NavLink} activeClassName="active" exact to="/add" key='add'>Add Stuff</Menu.Item>,
          <Menu.Item id={COMPONENT_IDS.NAVBAR_ADD_OPPORTUNITY} as={NavLink} activeClassName="active" exact to="/add-opportunity" key='add-opportunity'>Add Opportunity</Menu.Item>,
